...
class DatabaseHelper {
  ...
  initDb() async {
    ...
    String path = join(documentDirectory.path, "tasksDB.db");
  ...
  Future<int> saveItem(Tasks item) async {
  ...
  Future<Tasks> getItem(int id) async {
    var dbClient = await db;
  ...
  Future<int> updateItem(Tasks item) async {
    var dbClient = await db;
